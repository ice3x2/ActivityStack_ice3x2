...
public class TestActivityB extends StackActivity{
...
private TextView mTextViewLog;
	...
	private void initView() {
		...
		button.setText("Start Activity A");
		...
		if(!isFinishing()) {
			getWindow().getDecorView().postDelayed(new Runnable() {
				...
				public void run() {
					...
					log.append("AliveID : ").append(activityStack.getAliveID(TestActivityB.this)).append("\n");
					log.append(activityStack.toString()).append("\n");
					
					if(activityStack.getForegroundActivity() != TestActivityB.this) {
	...
	private View.OnClickListener mOnClickNew = new OnClickListener() {
		...
		public void onClick(View v) {
			Intent intent = new Intent(getApplicationContext(), TestActivityA.class);
